...
CREATE TABLE "work_items" (
	...
	"specific_content" jsonb DEFAULT '{}'::jsonb NOT NULL,
...
CREATE UNIQUE INDEX "work_items_tenant_queue_ref_uq" ON "work_items" USING btree ("tenant_id","queue","reference");--> statement-breakpoint
CREATE INDEX "work_items_tenant_queue_status_idx" ON "work_items" USING btree ("tenant_id","queue","status");