...
**Version:** 1.1 · **Date:** 2026-09-06 · **Author:** Mohammed Shaker · **Status:** Draft for review
...
4. Input document: a vendor tax invoice as the lab generates it (seeded defect: currency_mismatch (INV-CURRENCY))
...
13. The same screen in Arabic: the interface switches to right-to-left
14. Sandbox page: seed, reset and the background job log
...
![Figure 4. Input document: a vendor tax invoice as the lab generates it (seeded defect: currency_mismatch (INV-CURRENCY))](docs/pdd-assets/12-document-invoice.png)

**Figure 4. Input document: a vendor tax invoice as the lab generates it (seeded defect: currency_mismatch (INV-CURRENCY))**
...
### 4.2 P3: Arabic-first templates and degraded scans (levels 2 to 5)
...
![Figure 13. The same screen in Arabic: the interface switches to right-to-left](docs/pdd-assets/11-arabic-rtl.png)

**Figure 13. The same screen in Arabic: the interface switches to right-to-left**
...
![Figure 14. Sandbox page: seed, reset and the background job log](docs/pdd-assets/10-sandbox.png)

**Figure 14. Sandbox page: seed, reset and the background job log**
